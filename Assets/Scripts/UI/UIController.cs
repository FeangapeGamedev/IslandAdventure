...
namespace RPG.UI
{
    public class UIController : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            EventManager.OnChangePlayerPotions += HandleChangePlayerPotionCount;
        ...
        private void HandleChangePlayerPotionCount(int newPotionAmount)
        {
            potionsLabel.text = newPotionAmount.ToString();
        }
