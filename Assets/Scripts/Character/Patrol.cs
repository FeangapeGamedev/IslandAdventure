...
namespace RPG.Character
{
    public class Patrol : MonoBehaviour
    {
        ...
        private SplineContainer splineCpm;
        ...
        private void Awake()
        {
            ...
            splineCpm = splineGameObject.GetComponent<SplineContainer>();
            splineLength = splineCpm.CalculateLength();
            agentCmp = GetComponent<NavMeshAgent>();
        }

        public Vector3 GetNextPosition()
        {
            return splineCpm.EvaluatePosition(splinePosition);
        }
        ...
        public Vector3 GetFartherOutPosition()
        {
            ...
            return splineCpm.EvaluatePosition(tempSplinePosition);
        }
    }
