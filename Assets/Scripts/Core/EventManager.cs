...
namespace RPG.Core
{
    public static class EventManager
    {
        ...
        public static void RaiseChangePlayerPotions(int newHealthPotions) => OnChangePlayerPotions?.Invoke(newHealthPotions);
        public static void RaiseInitiateDialogue(TextAsset inkJSON, GameObject npc) => OnInitiateDialogue?.Invoke(inkJSON, npc);
        public static void RaiseTreasureChestUnloked(QuestItemSO item, bool showUI) => OnTreasureChestUnlocked?.Invoke(item, showUI);
